...
with open('calibration_A431_highEGF_fittedparams_norm_splined_1.txt', 'wb') as handle:
    pickle.dump(param_dict, handle)

numpy.save('calibration_allpositions_A431_highEGF_norm_splined_1.npy', mcmc.get_mixed_accepts(burn=opts.nsteps/10))
numpy.save('calibration_fittedparams_A431_highEGF_norm_splined_1.npy', list(zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx])))
