...
def rec_events():
    ...
    alias_model_components()
    # EGF binding to receptors
    # EGF receptor binding rates obtained from Chen et al Jacobian files
    bind_table([[                                                          EGF(st='M')],
                [erbb(ty='1', bl=None, bd=None, b=None, st='U', loc='C'),  (par['EGF_bind_ErbB1'])],
                [erbb(ty='3', bd=None, b=None, st='U', loc='C'),           None],
                [erbb(ty='4', bd=None, b=None, st='U', loc='C'),           None]],
                'bl', 'b')
    ...
    # MODIFICATION for Rexer model -- Monomers are not required to contain a ligand to form dimers but won't form active phosphorylated dimers without ligand (except ErbB2/ErbB2).
    ...
    # MODIFICATION for Rexer data: ErbB2/ErbB2 dimers can be directly phosphorylated -- allows signal without ligand
    # Also: All other dimers are only phosphorylated by interaction with dissassociated ErbB2P -- no phosphorylation of others w/o ligand present (in EGF version of model, EGF-ErbB1 containing dimers can be directly phosphorylated, and ErbB2 containing dimers can also be)
