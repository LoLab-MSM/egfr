...
data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_A431_lowEGF.npy')
ydatalEGF_norm = numpy.load(data_filename)
var_data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_var_A431_lowEGF.npy')
...
data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_A431_highHRG.npy')
ydatahHRG_norm = numpy.load(data_filename)
var_data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_var_A431_highHRG.npy')
...
data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_A431_lowHRG.npy')
ydatalHRG_norm = numpy.load(data_filename)
var_data_filename = os.path.join(os.path.abspath('../experimental_data'), 'experimental_data_var_A431_lowHRG.npy')
...
numpy.save('calibration_fittedparams_A431.npy', list(zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx])))
