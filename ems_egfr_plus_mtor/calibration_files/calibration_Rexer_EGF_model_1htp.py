...
from ..erbb_exec_Rexer_EGF import model
...
print('with EGF and activated ErbB2')
print(mcmc.accept_likelihood)
print(min(mcmc.likelihoods))

with open('calibration_Rexer_EGF_model_1htp', 'wb') as handle:
...
numpy.savetxt('calibration_Rexer_EGF_model_1htp.txt', combined, delimiter=' ', fmt='%s')
numpy.save('calibration_alltestedparams_Rexer_EGF_model_1htp.npy', mcmc.positions)
numpy.save('calibration_allpositions_Rexer_EGF_model_1htp.npy', mcmc.get_mixed_accepts(burn=opts.nsteps/10))
numpy.save('calibration_fittedparams_Rexer_EGF_model_1htp.npy', list(zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx])))
numpy.save('calibration_likelihoods_Rexer_EGF_model_1htp.npy', mcmc.likelihoods)
