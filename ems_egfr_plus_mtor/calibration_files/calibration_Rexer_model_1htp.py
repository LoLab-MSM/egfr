...
data_filename = os.path.join(os.path.abspath('../experimental_data'), 'RPPA_experimental_data_SKBR3_1htp.npy')
ydata_exp = numpy.load(data_filename)
var_data_filename = os.path.join(os.path.abspath('../experimental_data'), 'RPPA_experimental_data_var_SKBR3_1htp.npy')
...
numpy.save('calibration_fittedparams_Rexer_model_skbr3_1htp.npy', list(zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx])))
