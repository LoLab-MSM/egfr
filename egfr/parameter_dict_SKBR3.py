...
# Parameters for EGFR Model - SKBR-3 cells
...
parameter_dict = OrderedDict([
    ('initial_amounts', # Initial values for all starting species (in molecules/cell)
     [Parameter('erbb1_0', 7705), #RPPA
      Parameter('erbb2_0', 399477), #RPPA
      ...
      Parameter('PI3K_0', 4559), #RPPA
      Parameter('SHP2_0', 1e6), #Average of other cell types
      Parameter('PIP_0',     7e5), #Average of other cell types
      Parameter('PTEN_0',    3981), #RPPA
      Parameter('SHP_0',     3200), #Average of other cell types
      Parameter('AKT_0',     39369), #RPPA
      Parameter('PDK1_0',     45672), #RPPA
      Parameter('PP2A_III_0', 4.5e6), #Average of other cell types
      Parameter('Pase9t_0', 0), #c521
      Parameter('ERKPP_0', 4009), #RPPA
      Parameter('AKTPP_0', 4348), #RPPA
      Parameter('AKTP_0', 5559), #RPPA
      Parameter('ErbB1P_0', 2759), #RPPA
      Parameter('ErbB2P_0', 2970), #RPPA
    ]),
