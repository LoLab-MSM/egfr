    ...
    try:
        ...
        if numpy.isnan(objAKT[mcmc.iter]) or numpy.isnan(objErb[mcmc.iter]) or numpy.isnan(objERK[mcmc.iter]) is True:
            ...
            for param, new_value in zip(opts.estimate_params, fitted_values):
                ...
                with open('calibration_H1666_highEGF_findingnans2', 'wb') as handle:
                    ...
                    numpy.savetxt('calibration_H1666_highEGF_paramchange_findingnans2.txt', combined, delimiter=' ', fmt='%s')
                    numpy.save('calibration_alltestedparams_H1666_highEGF_findingnans2.npy', mcmc.positions)
                    numpy.save('calibration_allpositions_H1666_highEGF_findingnans2.npy', mcmc.get_mixed_accepts(burn=opts.nsteps/10))
                    numpy.save('calibration_fittedparams_H1666_highEGF_findingnans2.npy', zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx]))
                    numpy.save('calibration_likelihoods_H1666_highEGF_findingnans2.npy', mcmc.likelihoods)
                    numpy.save('calibration_AKTlikelihoods_H1666_highEGF_findingnans2.npy', objAKT)
                    numpy.save('calibration_Erblikelihoods_H1666_highEGF_findingnans2.npy', objErb)
                    numpy.save('calibration_ERKlikelihoods_H1666_highEGF_findingnans2.npy', objERK)
                    sys.exit()
...
data_filename = os.path.join(os.path.dirname(__file__), 'experimental_data_H1666_highEGF_unnorm_splined.npy')
ydata_exp_he = numpy.load(data_filename)
yslice_exp_he = ydata_exp_he[splined_exp_pts]
var_data_filename = os.path.join(os.path.dirname(__file__), 'experimental_data_var_H1666_highEGF_unnorm_splined.npy')
...
tspan = numpy.linspace(0,7200, num=14400)
exptimepts = numpy.array([0, 299, 599, 899, 1199, 1799, 3599, 5399, 7199, 14399])
...
with open('calibration_H1666_highEGF_fittedparams_unnorm_splined_fromhighEGFval_priorvar1.5_intchange', 'wb') as handle:
    pickle.dump(param_dict, handle)
...
change = numpy.log10(newvalues_array / oldvalues_array)
combined = numpy.column_stack((name, oldvalues, newvalues, change))
numpy.savetxt('calibration_H1666_highEGF_paramchange_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.txt', combined, delimiter=' ', fmt='%s')
numpy.save('calibration_alltestedparams_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', mcmc.positions)
numpy.save('calibration_allpositions_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', mcmc.get_mixed_accepts(burn=opts.nsteps/10))
numpy.save('calibration_fittedparams_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', zip(opts.estimate_params, mcmc.cur_params()[mcmc.estimate_idx]))
numpy.save('calibration_likelihoods_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', mcmc.likelihoods)
numpy.save('calibration_AKTlikelihoods_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', objAKT)
numpy.save('calibration_Erblikelihoods_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', objErb)
numpy.save('calibration_ERKlikelihoods_H1666_highEGF_unnorm_splined_fromhighEGFval_priorvar1.5_intchange.npy', objERK)
