...
Model()
from egfr import chen_modules_Rexer_EGF

# Declare monomers
chen_modules_Rexer_EGF.rec_monomers()
chen_modules_Rexer_EGF.mapk_monomers()
chen_modules_Rexer_EGF.akt_monomers()
chen_modules_Rexer_EGF.crosstalk_monomers()

# Generate the upstream and downstream sections
chen_modules_Rexer_EGF.rec_events()
chen_modules_Rexer_EGF.mapk_events()
chen_modules_Rexer_EGF.akt_events()
chen_modules_Rexer_EGF.crosstalk_events()

# Initial protein concentrations
chen_modules_Rexer_EGF.rec_initial_inhib_LAP()
chen_modules_Rexer_EGF.rec_initial_lig_pEGF()
chen_modules_Rexer_EGF.rec_initial()
chen_modules_Rexer_EGF.mapk_initial()
chen_modules_Rexer_EGF.akt_initial()
chen_modules_Rexer_EGF.crosstalk_initial()
