...
data_filename = os.path.join(os.path.dirname(__file__), 'experimental_data_H1666_highEGF.npy')
ydata_norm = numpy.load(data_filename)
var_data_filename = os.path.join(os.path.dirname(__file__), 'experimental_data_var_H1666_highEGF.npy')
